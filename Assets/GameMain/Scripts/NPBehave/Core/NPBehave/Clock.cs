    ...
    public class Clock
    {
        ...
        public void Update()
        {
            ...
            foreach (var frameActionPair in AllFrameActions)
            {
                ...
                if ( frameAction.TargetTickFrame<=(uint)TimeInfo.Instance.ClientFrameTime() &&
        ...
        {
            frameAction.TargetTickFrame = (uint)TimeInfo.Instance.ClientFrameTime() + frameAction.IntervalFrame;
        }
    }
}