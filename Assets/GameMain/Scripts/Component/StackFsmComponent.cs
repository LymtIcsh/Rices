...
namespace Suture
{
    ...
    /// 适用于动画切换的栈式状态机
    /// </summary>
    public static class StackFsmComponent 
    {
        /// <summary>
        /// 当前持有的状态，用于外部获取对比，减少遍历次数
        /// Key为状态类型，V为具体状态类
        /// </summary>
        private static Dictionary<StateTypes, List<AFsmStateBase>>
            m_States = new Dictionary<StateTypes, List<AFsmStateBase>>();
        
        /// <summary>
        /// 用于内部轮询，切换的状态类
        /// </summary>
        private static LinkedList<AFsmStateBase> m_FsmStateBases = new LinkedList<AFsmStateBase>();
        ...
        // {
        //     return aFsmStateBase == GetCurrentFsmState();
        // }
        ...
        //     {
        //         if (string.Equals(aFsmStateBase.StateName, stateName, StringComparison.Ordinal))
        //         {
        ...
        //         if (tempFirstState != null)
        //             UpdateAction -= tempFirstState.OnUpdate;
        //
        //         fsmStateToInsert.OnEnter(this);
        //         UpdateAction += fsmStateToInsert.OnUpdate;
        //     }
        // }
        //
        // // /// <summary>
