...
namespace Suture
{
    public class RoomManagerComponent:GameFrameworkComponent
    {
        /// <summary>
        /// 组队房间
        /// </summary>
        ...
        public Room CreateLobbyRoom()
        {
          Room room =  GameEntry.Entity.CreateEntity<Room>("LobbyRoom","Room", null);
        ...
        public Room GetOrCreateBattleRoom()
        {
            if (BattleRoom == null)
            {
                BattleRoom =  GameEntry.Entity.CreateEntity<Room>("BattleRoom", "Room",null);
