...
namespace Suture
{
    ...
    /// </summary>
    //[ExecuteAlways]
    public class RangeCheckComponent : GameFrameworkComponent
    {
        public DetectionEnum currType = DetectionEnum.None;
        ...
        //     if (null != mPlayer)
        //     {
        //         Debug.DrawLine(mPlayer.position, mPlayer.position + mPlayer.forward * 8, Color.yellow);
        //     }
        //
        //     bool bResult = false;
        //     switch (currType)
        //     {
        //         case DetectionEnum.None:
        //             break;
        //         case DetectionEnum.Ray:
        //             break;
        //         case DetectionEnum.Fanshaped:
        //             bResult = FanshapedCheck(mPlayer, mTarget, 45, 5);
        //             break;
        //         case DetectionEnum.Circle:
        //             bResult = CircleCheck(mPlayer, mTarget, 6);
        //             break;
        //         case DetectionEnum.Triangle:
        //             bResult = TriangleCheck(mPlayer, mTarget, 1, 10);
        //             break;
        //         case DetectionEnum.Sector:
        //             bResult = SectorCheck(mPlayer, mTarget, 45, 5, 8);
        //             break;
        //         case DetectionEnum.Ring:
        //             bResult = RingCheck(mPlayer, mTarget, 4, 8);
        //             break;
        //         case DetectionEnum.Orthogon:
        //             bResult = RectangleCheck(mPlayer, mTarget, 2, 8);
        //             break;
        //         default:
        //             break;
        //     }
        ...
        /// 规范位置(去除高度带来的影响)
        /// </summary>
        Vector3 NormalizePosition(Vector3 position, float hight = 0.0f)
        {
            // Vector3 tempPosition = Vector3.zero;
            // tempPosition.x = position.x;
            // tempPosition.y = hight;
            // tempPosition.z = position.z;
            return new Vector3(position.x, hight, position.z);
        }
