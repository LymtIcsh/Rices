...
namespace Suture
{
    ...
    public class UniversalGraphWindow : BaseGraphWindow
    {
        ...
        /// </summary>
        public const string NodeGraphProcessorPathPrefix = "Assets/GameMain/Plugins/NodeEditor/NodeGraphProcessor";
        ...
        private void InitGUIStyles(ref bool result)
        {
            if (!result)
            {
                EditorGUIStyleHelper.SetGUIStylePadding(nameof(EditorStyles.toolbarButton),
                    new RectOffset(15, 15, 0, 0));
                result = true;
            }
        }
