...
namespace Suture
{
    ...
    public class NPBehaveGraphView : UniversalGraphView
    {
        ...
        /// </summary>
        /// <returns></returns>
        private bool IsOverlaps(NP_NodeView node1, NP_NodeView node2)
        {
        ...
        private void CenterChild(NP_NodeView parentNodeView)
        {
            ...
            if (parentNodeView.childCount == 1)
            {
                dx = parentNodeView.CachedPositionRect.x - childNodes[0].CachedPositionRect.x +
                     (parentNodeView.CachedSizeRect.width - childNodes[0].CachedSizeRect.width) / 2;
            }
        ...
        private NP_NodeView FindCommonParentNode(NP_NodeView node1, NP_NodeView node2)
        {
